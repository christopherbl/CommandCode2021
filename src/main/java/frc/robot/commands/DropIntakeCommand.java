...
public class DropIntakeCommand extends CommandBase {
   ...
   */
  public DropIntakeCommand(AFineAdditionToMyCollection intakeWheelsSubsystem, AnotherHappyLanding dropIntakeSubsystem) {
  ...
  @Override
  public void execute() {
    m_anotherHappyLanding.m_lowerIntake();
  }
  ...
  public boolean isFinished() {
    if(timer.get() >= tempTimer + Constants.TIME_FOR_DROPPING_INTAKE){
      return true;
    }else{
      return false;
    }
