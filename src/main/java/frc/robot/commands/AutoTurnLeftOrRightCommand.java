...
public class AutoTurnLeftOrRightCommand extends CommandBase {
  private final AutoDrive m_autoDrive;
  private final int m_distance;
  /**
   * Creates a new AutoForwardsOrBackwardsCommand.
   */
  public AutoTurnLeftOrRightCommand(AutoDrive drive, NowThisIsPodracing m_nowThisIsPodracing, int distance) {
    m_autoDrive = drive;
    m_distance = distance;
  ...
  @Override
  public void execute() {
    m_autoDrive.m_turnLeftOrRight(m_distance);
  }
