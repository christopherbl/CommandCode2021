...
public class DriveAheadCommand extends CommandBase {
   ...
   */
  public DriveAheadCommand(NowThisIsPodracing driveTrain, double targetHeading) {
  ...
  public void initialize() {
    this.correctLoops = 0;
    targetHeading = driveTrain.getLeftMeters() + targetHeading;
  ...
  @Override
  public void execute() {
    double currentHeading = driveTrain.getLeftMeters();
    ...
    System.out.printf("TargetAdj= %.2f ",targetHeading);
    ...
    driveTrain.m_arcadeDrive(1, 0, 1);
  }
